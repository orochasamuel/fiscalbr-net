...
{
    public class BlocoI : IBlocoSped
    {
        ...
        public class RegistroI010 : RegistroSped
        {
            ...
            /// </summary>
            [SpedCampos(3, "IND_ATIV", "N", 2, 0, true, 2)]
            public string IndAtiv { get; set; }

            /// <summary>
            ///     Informação Complementar
            /// </summary>
            [SpedCampos(4, "INFO_COMPL", "C", 0, 0, true, 2)]
        ...
        public class RegistroI300 : RegistroSped
        {
            ...
            /// </summary>
            [SpedCampos(2, "COD_COMP", "C", 60, 0, true, 2)]
            ...
            /// </summary>
            [SpedCampos(3, "DET_VALOR", "N", 0, 2, true, 2)]
            public string DetValor { get; set; }

            /// <summary>
            ///     Código da conta contábil referente ao valor informado no campo 03
            /// </summary>
            [SpedCampos(4, "COD_CTA", "C", 255, 0, true, 2)]
            public string CodCta { get; set; }

            /// <summary>
            ///   Informação  Complementar  dos  dados  informados  no registro
            /// </summary>
            [SpedCampos(5, "INFO_COMPL", "C", 0, 0, true, 2)]
            public string InfoCompl { get; set; }
