...
namespace FiscalBr.ECF
{
    public class BlocoM
    {
        ...
        public class RegM010 : RegistroBaseSped
        {
            ...
            [SpedCampos(2, "COD_CTA_B", "C", 0, 0, true, 15)]
            public string CodCtaB { get; set; }

            [SpedCampos(3, "DESC_CTA_LAL", "C", 0, 0, true, 15)]
            public string DescCtaLal { get; set; }

            [SpedCampos(4, "DT_AP_LAL", "C", 8, 0, true, 15)]
            public DateTime DtApLal { get; set; }

            [SpedCampos(5, "COD_LAN_ORIG", "C", 6, 0, false, 15)]
            public string CodLanOrig { get; set; }

            [SpedCampos(6, "DESC_LAN_ORIG", "C", 0, 0, false, 15)]
            public string DescLanOrig { get; set; }

            [SpedCampos(7, "DT_LIM_LAL", "C", 8, 0, false, 15)]
            public DateTime? DtLimLal { get; set; }

            [SpedCampos(8, "COD_TRIBUTO", "C", 1, 0, true, 15)]
            public string CodTributo { get; set; }

            [SpedCampos(9, "VL_SALDO_INI", "N", 19, 2, true, 15)]
            public decimal VlSaldoIni { get; set; }

            [SpedCampos(10, "IND_Vl_SALDO_INI", "C", 1, 0, true, 15)]
            public string IndVlSaldoIni { get; set; }

            [SpedCampos(11, "CNPJ_SIT_ESP", "N", 14, 0, false, 15)]
        ...
        public class RegM300 : RegistroBaseSped
        {
            ...
            [SpedCampos(4, "TIPO_LANCAMENTO", "C", 1, 0, false, 15)]
            public string TipoLancamento { get; set; }

            [SpedCampos(5, "IND_RELACAO", "N", 1, 0, false, 15)]
            public int IndRelacao { get; set; }

            [SpedCampos(6, "VALOR", "NS", 19, 2, false, 15)]
            public decimal Valor { get; set; }

            [SpedCampos(7, "HIST_LAN_LAL", "C", 500, 0, false, 15)]
        ...
        public class RegM305 : RegistroBaseSped
        {
            ...
            [SpedCampos(3, "VL_CTA", "N", 19, 2, true, 15)]
            public decimal VlCta { get; set; }

            [SpedCampos(4, "IND_ VL_CTA", "C", 1, 0, true, 15)]
        ...
        public class RegM310 : RegistroBaseSped
        {
            ...
            [SpedCampos(4, "VL_CTA", "N", 19, 2, true, 15)]
            public decimal VlCta { get; set; }

            [SpedCampos(5, "IND_VL_CTA", "C", 1, 0, true, 15)]
            public string IndVlCta { get; set; }
        }
        ...
        public class RegM312 : RegistroBaseSped
        {
            ...
            [SpedCampos(2, "NUM_LCTO", "C", 50, 0, true, 15)]
        ...
        public class RegM315 : RegistroBaseSped
        {
            ...
            [SpedCampos(2, "IND_PROC", "C", 1, 0, true, 15)]
            public int IndProc { get; set; }

            [SpedCampos(3, "NUM_PROC", "C", 20, 0, true, 15)]
        ...
        public class RegM410 : RegistroBaseSped
        {
            ...
            [SpedCampos(2, "COD_CTA_B", "C", 0, 0, false, 15)]
            public string CodCtaB { get; set; }

            [SpedCampos(3, "COD_TRIBUTO", "C", 1, 0, true, 15)]
            public string CodTributo { get; set; }

            [SpedCampos(4, "VAL_LAN_LALB_PB", "N", 19, 2, true, 15)]
            public decimal ValLanLalbPb { get; set; }

            [SpedCampos(5, "IND_VAL_LAN_LALB_P", "C", 0, 0, true, 15)]
            public string IndValLanLalbP { get; set; }

            [SpedCampos(6, "COD_CTA_B_CTP", "C", 0, 0, false, 15)]
            public string CodCtaBCtp { get; set; }

            [SpedCampos(7, "HIST_LAN_LALB", "C", 0, 0, true, 15)]
            public string HistLanLalb { get; set; }

            [SpedCampos(8, "IND_LAN_ANT", "C", 1, 0, true, 15)]
        ...
        public class RegM500 : RegistroBaseSped
        {
            ...
            [SpedCampos(4, "SD_INI_LAL", "N", 19, 2, true, 15)]
            public decimal SdIniLal { get; set; }

            [SpedCampos(5, "IND_ SD_INI_LAL", "C", 1, 0, true, 15)]
            public string IndSdIniLal { get; set; }

            [SpedCampos(6, "VL_LCTO_PARTE_A", "N", 19, 2, true, 15)]
            public decimal VlLctoParteA { get; set; }

            [SpedCampos(7, "IND_ VL_LCTO_PARTE_A", "C", 1, 0, true, 15)]
            public string IndVlLctoParteA { get; set; }

            [SpedCampos(8, "VL_LCTO_PARTE_B", "N", 19, 2, true, 15)]
            public decimal VlLctoParteB { get; set; }

            [SpedCampos(9, "ND_ VL_LCTO_PARTE_B", "C", 1, 0, true, 15)]
            public string IndVlLctoParteB { get; set; }

            [SpedCampos(10, "SD_FIM_LAL", "N", 19, 2, true, 15)]
            public decimal SdFimLal { get; set; }

            [SpedCampos(11, "IND_ SD_FIM_LAL", "C", 1, 0, true, 15)]
