...
namespace FiscalBr.ECF
{
    public class BlocoQ
    {
        ...
        public class RegQ100 : RegistroBaseSped
        {
            ...
            [SpedCampos(2, "DATA", "N", 8, 0, true, 15)]
            public DateTime Data { get; set; }

            [SpedCampos(3, "NUM_DOC", "C", 0, 0, false, 15)]
            public string NumDoc { get; set; }

            [SpedCampos(4, "HIST", "C", 0, 0, true, 15)]
            public string Hist { get; set; }

            [SpedCampos(5, "VL_ENTRADA", "N", 19, 2, false, 15)]
            public decimal? VlEntrada { get; set; }

            [SpedCampos(6, "VL_SAIDA", "N", 19, 2, false, 15)]
            public decimal? VlSaida { get; set; }

            [SpedCampos(7, "SLD_FIN", "NS", 19, 2, true, 15)]
